...
@item @sc{Singular} sources
@code{www.mathematik.uni-kl.de:/pub/Math/Singular/src}
(or, via a WWW browser from http://www.mathematik.uni-kl.de/ftp/pub/Math/Singular/src)
@end table
