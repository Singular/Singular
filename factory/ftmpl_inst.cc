...
template List<List<CanonicalForm> > Union ( const List<List<CanonicalForm> >&, const List<List<CanonicalForm> >&, int operator== (const List<CanonicalForm> &, const List<CanonicalForm> &));
template List<CanonicalForm> Difference ( const List<CanonicalForm> &, const List<CanonicalForm> & );
template List<List<CanonicalForm> > Difference ( const List<List<CanonicalForm> >&, const List<List<CanonicalForm> >&, int operator== (const List<CanonicalForm> &, const List<CanonicalForm> &));
template List<List<CanonicalForm> > Difference ( const List<List<CanonicalForm> >&, const List<CanonicalForm>&, int operator== (const List<CanonicalForm> &, const List<CanonicalForm> &));
template CanonicalForm prod ( const List<CanonicalForm> & );
template bool find ( const List<CanonicalForm> &, const CanonicalForm&);
template bool find ( const List<List<CanonicalForm> >&, const List<CanonicalForm>&, int operator== (const List<CanonicalForm> &, const List<CanonicalForm> &));
