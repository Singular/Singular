...
,{D(jjLIFTSTD_LIMIT),  LIFTSTD_CMD,IDEAL_CMD,  IDEAL_CMD,  MATRIX_CMD, INT_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjLIFTSTD_LIMIT),  LIFTSTD_CMD,MODUL_CMD,  MODUL_CMD,  MATRIX_CMD, INT_CMD, ALLOW_NC |ALLOW_RING}
