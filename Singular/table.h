...
//,{D(jjSMATRIX_Id),     SMATRIX_CMD,SMATRIX_CMD,IDEAL_CMD,  INT_CMD,    INT_CMD, ALLOW_NC |ALLOW_RING}
//,{D(jjSMATRIX_Mo),     SMATRIX_CMD,SMATRIX_CMD,MODUL_CMD,  INT_CMD,    INT_CMD, ALLOW_NC |ALLOW_RING}
//,{D(jjSMATRIX_Ma),     SMATRIX_CMD,SMATRIX_CMD,MATRIX_CMD, INT_CMD,    INT_CMD, ALLOW_NC |ALLOW_RING}
#ifdef OLD_RES
