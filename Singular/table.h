...
,{D(jjLIFTSTD_LIMIT),  LIFTSTD_CMD,IDEAL_CMD,  IDEAL_CMD,  MATRIX_CMD, IDEAL_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjLIFTSTD_LIMIT),  LIFTSTD_CMD,MODUL_CMD,  MODUL_CMD,  MATRIX_CMD, MODUL_CMD, ALLOW_NC |ALLOW_RING}
