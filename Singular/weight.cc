...
****************************************/
static char rcsid[] = "$Header: /exports/cvsroot-2/cvsroot/Singular/weight.cc,v 1.1.1.1 1997-03-19 13:18:52 obachman Exp $";
...
static double nsqr;
static double (*wFunctional)(int *degw, int *lpol, int npol,
