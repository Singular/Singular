...
//#define ENDWALKS //print the size of the last omega-homogenoues Gr�bner basis
...
/* 08.09.02 */
/******** THE NEW GR�BNER WALK ALGORITHM **********/
/* Gr�bnerwalk with a recursive "second" alternative GW, REC_GB_Mwalk
...
/* compute the reduced Gr�bner basis of an ideal <Go> w.r.t. lp */
