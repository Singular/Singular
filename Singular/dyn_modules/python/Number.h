...
//   class error_handle_traits>;
  ...
  Number& operator+=(const Number & n2)
  {
    ...
    number nv=n_Add(n,n2.n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n=nv;
    return *this;
  }
  Number& operator*=(const Number & n2)
  {
    ...
    number nv=n_Mult(n,n2.n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n=nv;
    return *this;
  }
  Number& operator-=(const Number & n2)
  {
    ...
    number nv=n_Sub(n,n2.n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n=nv;
    return *this;
  }
  Number& operator/=(const Number & n2)
  {
    ...
    number nv=n_Div(n,n2.n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n=nv;
    return *this;
  }
  ...
  {
    n_Delete(&n,r.get()->cf);
    n=n_Init(n2,r.get()->cf);
    return *this;
  }
  Number& operator+=(int n2)
  {
    number n2n=n_Init(n2,r.get()->cf);
    number nv=n_Add(n,n2n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n_Delete(&n2n,r.get()->cf);
    n=nv;
    return *this;
  }
  Number& operator*=(int n2)
  {
    number n2n=n_Init(n2,r.get()->cf);
    number nv=n_Mult(n,n2n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n_Delete(&n2n,r.get()->cf);
    n=nv;
    return *this;
  ...
  {
    number n2n=n_Init(n2,r.get()->cf);
    number nv=n_Sub(n,n2n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n_Delete(&n2n,r.get()->cf);
    n=nv;
    return *this;
  ...
  {
    number n2n=n_Init(n2,r.get()->cf);
    number nv=n_Div(n,n2n,r.get()->cf);
    n_Delete(&n,r.get()->cf);
    n_Delete(&n2n,r.get()->cf);
    n=nv;
    return *this;
  ...
  {
    r=n.r;
    this->n=n_Copy(n.n,r.get()->cf);
  }
  Number(number n, ring r)
  {
    this->n=n_Copy(n,r->cf);
    this->r=r;
  }
  Number(int n, ring r)
  {
    this->r=r;
    this->n=n_Init(n,r->cf);
  }
...
inline bool operator==(const Number &n1, const Number& n2)
{
  if(n1.r!=n2.r)
    return false;
  return n_Equal(n1.n,n2.n,n1.r.get()->cf);
}
...
{
  return n_Equal(n1.n,Number(n2,n1.r).n,n1.r.get()->cf);
}
