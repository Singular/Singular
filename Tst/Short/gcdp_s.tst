// $Id: gcdp_s.tst,v 1.1.1.1 1998-04-17 15:07:40 obachman Exp $

//
// gcdp_s.tst - short tests for gcd calculations mod p.
//
// Note: gcd(0, x) fails with a SEGV signal!
// To Do: gcd calculations over transcendental extensions of
// finite fields.
//

LIB "tst.lib";
tst_init();
tst_ignore("CVS ID  : $Id: gcdp_s.tst,v 1.1.1.1 1998-04-17 15:07:40 obachman Exp $");
