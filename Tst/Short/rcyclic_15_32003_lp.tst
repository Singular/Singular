    ...
    LIB "tst.lib";
    tst_init();
    ring MYRINGNAME=32003,(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15),lp;
...
x1*x2*x3*x4*x5*x6*x7*x8*x9*x10*x11*x12*x13*x14+x1*x3*x4*x5*x6*x7*x8*x9*x10*x11*x12*x13*x14*x15+x2*x3*x4*x5*x6*x7*x8*x9*x10*x11*x12*x13*x14*x15;
    option(redSB);
    slimgb(MYIDEALNAME);
    kill MYRINGNAME;
    tst_status(1);exit;
