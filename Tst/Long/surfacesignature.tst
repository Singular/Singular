...
a = signatureNemethi(N,f,1);
b = signatureNemethi(N,f,2);
a;
a == b;

g1 = f^3 + x9y8;
signatureNemethi(N,g1,2);

g3 = f^5 + x20y20;
signatureNemethi(N,g3,2);
...
a = signatureNemethi(N,f,1);
b = signatureNemethi(N,f,2);
c = signatureNemethi(N,f,3);
a;
a == b;
b == c;

g1 = f^2 + x5y5;
a = signatureNemethi(N,g1,1);
b = signatureNemethi(N,g1,2);
a;
a == b;

g2 = f^3 + x11y11;
a = signatureNemethi(N,g2,1);
b = signatureNemethi(N,g2,2);
a;
a == b;
