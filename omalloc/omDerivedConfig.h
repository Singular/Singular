...
/* Accepted SIZEOF_SYSTEM_PAGE values are checked by configure. */
#if SIZEOF_SYSTEM_PAGE == 65536
#define LOG_BIT_SIZEOF_SYSTEM_PAGE 16
#elif SIZEOF_SYSTEM_PAGE == 16384
