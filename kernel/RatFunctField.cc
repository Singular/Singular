...
****************************************/
/* $Id: RatFunctField.cc 12469 2010-05-14 10:39:49Z frank $ */
/*
...
typedef struct snratIdeal* nratIdeal;

nratIdeal nratI = NULL;

omBin snratIdeal_bin = omGetSpecBin(sizeof(snratIdeal));

int nratNumbOfPar;
#define nratParNames (currRing->parameter)
static int nratIsChar0;
static ring nratMapRing;

#ifdef LDEBUG
  #define nratTest(a) nratDBTest(a,__FILE__,__LINE__)
  BOOLEAN nratDBTest(number a, const char *f,const int l);
#else
  #define nratTest(a)
#endif
/* LDEBUG */

number (*nratMap)(number from);
/* procedure variables */
static numberfunc
