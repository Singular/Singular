...
THREAD_VAR denominator_list DENOMINATOR_LIST=NULL;
...
THREAD_VAR int     HCord;
THREAD_VAR int     Kstd1_deg;
THREAD_VAR int     Kstd1_mu=32000;
...
THREAD_VAR static BOOLEAN sloppy_max = FALSE;
