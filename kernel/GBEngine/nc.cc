...
{
  ideal J = kStd2(I, currRing->qideal, testHomog, NULL, (bigintmat*)NULL, 0, 0, NULL); // in currRing!!!
...
//            flag = false;
    ...
    J = kStd2(id_tmp, currRing->qideal, testHomog, NULL, (bigintmat*)NULL, 0, iSize); // J = J + K, J - std // in currRing!
    SI_RESTORE_OPT1(save1);
#else
    J=kStd2(id_tmp, currRing->qideal,testHomog,NULL,NULL,0,0,NULL);
#endif
...
ideal Approx_Step(ideal L)
{
  ...
  int syzcomp = 0;
  ideal I = kStd2(L, currRing->qideal,testHomog,NULL,(bigintmat*)NULL,0,0,NULL);
  idSkipZeroes(I);
  ideal s_I;
  int idI = idElem(I);
  ...
  for (i=1; i<=N; i++ )
  {
    ...
    if (flag >0)
    {
      ...
      s_h3 = kStd2(s_h2, currRing->qideal,(tHomog)FALSE,NULL,(bigintmat*)NULL,syzcomp,idI);
      SI_RESTORE_OPT1(save1);
      //idShow(s_h3);
      if (orig_ring != syz_ring)
      {
      ...
      idTest(s_h3);
      S[syzcnt]=kStd2(s_h3,currRing->qideal,(tHomog)FALSE,NULL,(bigintmat*)NULL);
      syzcnt++;
      idDelete(&s_h3);
    } // end if flag >0
    else
  ...
  if (syzcnt >0)
  {
    ...
    PrintS("final std");
    res = kStd2(res, currRing->qideal,testHomog,NULL,(bigintmat*)NULL,0,0,NULL);
    idSkipZeroes(res);
    return(res);
  }
  else
