...
systems; the archive carries the MinGW, cddlib, FLINT, NTL, readline, and other
native runtime DLLs.  It also contains the standard Singular libraries and
relevant third-party license files.
