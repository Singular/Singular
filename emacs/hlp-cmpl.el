...
(setq singular-help-topics-alist
  '(
    ...
    ("autKS" . "autKS.               (line   6")
    ("Automatic Deduction" . "ADGT.                (line  51")
    ("Automatic Demonstration" . "ADGT.                (line  51")
    ...
    ("betti number" . "goettsche_lib.       (line  44")
    ...
    ("Geometric Theorems" . "ADGT.                (line  51")
    ...
    ("Goettsche's formula" . "goettsche_lib.       (line  44")
    ...
    ("Kronecker modules" . "goettsche_lib.       (line  44")
    ...
    ("Macdonald's formula" . "goettsche_lib.       (line  44")
