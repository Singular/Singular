...
(setq singular-help-topics-alist
  '(
    ...
    ("Bernstein operator" . "dmod_lib.            (line 108")
    ...
    ("Briancon-Maisonobe algorithm" . "dmod_lib.            (line 108")
    ...
    ("debugLib, option" . "option.              (line 181")
    ("dec1var" . "dec1var.             (line   6")
    ("decimal" . "decimal.             (line   6")
    ("Decker, Wolfram" . "Preface.             (line 145")
    ...
    ("global Bernstein-Sato polynomial" . "dmod_lib.            (line 108")
    ...
    ("grdeg" . "grdeg.               (line   6")
    ("Greuel, Gert-Martin" . "Preface.             (line 145")
    ...
    ("Groebner fan" . "polymake_lib.        (line 119")
    ...
    ("hyperplane arrangement" . "dmod_lib.            (line 108")
    ...
    ("loadLib, option" . "option.              (line 188")
    ("loadProc, option" . "option.              (line 191")
    ...
    ("LOT algorithm" . "dmod_lib.            (line 108")
    ...
    ("lpKDimCheck" . "lpKDimCheck.         (line   6")
    ...
    ("Newton polytope" . "polymake_lib.        (line 119")
    ...
    ("notWarnSB, option" . "option.              (line 197")
    ("npar" . "npar.                (line   6")
    ("npars" . "npars.               (line   6")
    ("NPos" . "NPos.                (line   6")
    ...
    ("nvars" . "nvars.               (line   6")
    ("Oaku-Takayama algorithm" . "dmod_lib.            (line 108")
    ...
    ("parametric annihilator" . "dmod_lib.            (line 108")
    ...
    ("Pfister, Gerhard" . "Preface.             (line 145")
    ...
    ("polymake" . "polymake_lib.        (line 119")
    ...
    ("polytope" . "polymake_lib.        (line 119")
    ...
    ("read" . "read.                (line   6")
    ("reading, option" . "option.              (line 204")
    ...
    ("redefine, option" . "option.              (line 207")
    ...
    ("root of Bernstein-Sato polynomial" . "dmod_lib.            (line 108")
    ...
    ("Scho\"nemann, Hans" . "Preface.             (line 145")
    ...
    ("secondary fan" . "polymake_lib.        (line 119")
    ("secondary polytope" . "polymake_lib.        (line 119")
    ...
    ("tropical curves" . "tropical_lib.        (line 176")
    ...
    ("tropical polynomials" . "tropical_lib.        (line 176")
    ...
    ("vertexAdjacencyGraph" . "vertexAdjacencyGraph")
    ("vertexEdgeGraph" . "vertexEdgeGraph.     (line   6")
