...
void p_LPExpVappend(int *m1ExpV, int *m2ExpV, int m1Last, int m2Last, const ring ri);
void p_LPExpVprepend(int *m1ExpV, int *m2ExpV, int m1Last, int m2Last, const ring ri);
