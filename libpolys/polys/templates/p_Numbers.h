...
#define n_Mult_RingGeneral(n1, n2, r)      r->cf->nMult(n1, n2, r->cf)
#define n_Add_RingGeneral(n1, n2, r)       r->cf->nAdd(n1, n2, r->cf)
#define n_IsZero_RingGeneral(n, r)         r->cf->nIsZero(n, r->cf)
#define n_Equal_RingGeneral(n1, n2, r)     r->cf->nEqual(n1, n2, r->cf)
#define n_Neg_RingGeneral(n, r)            r->cf->nNeg(n, r->cf)
#define n_Sub_RingGeneral(n1, n2, r)       r->cf->nSub(n1, n2, r->cf)
//#define n_InpMult_RingGeneral(n1, n2, r)   r->cf->nInpMult(n1, n2, r->cf)
#define n_InpMult_RingGeneral(n1, n2, r)   ndInpMult(n1, n2, r->cf)
#define n_InpAdd_RingGeneral(n1, n2, r)    n1=ndInpAdd(n1, n2, r->cf)
#endif
...
#define n_InpAdd_FieldQ(n1, n2, r)  n1=nlInpAdd(n1, n2, r->cf)
#endif
