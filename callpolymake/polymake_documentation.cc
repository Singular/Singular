...
void init_polymake_help()
{
  ...
  module_help_main("polymake.so",omStrDup(polymake_help));
 ...
 module_help_proc("polymake.so","isReflexive", omStrDup(isReflexive_help));
 ...
 module_help_proc("polymake.so","isBounded", omStrDup(isBounded_help));
 ...
 module_help_proc("polymake.so","isGorenstein", omStrDup(isGorenstein_help));
 ...
 module_help_proc("polymake.so","gorensteinIndex", omStrDup(gorensteinIndex_help));
 ...
 module_help_proc("polymake.so","gorensteinVector", omStrDup(gorensteinVector_help));
 ...
 module_help_proc("polymake.so","isCanonical", omStrDup(isCanonical_help));
 ...
 module_help_proc("polymake.so","isTerminal", omStrDup(isTerminal_help));
 ...
 module_help_proc("polymake.so","latticeVolume", omStrDup(latticeVolume_help));
 ...
 module_help_proc("polymake.so","latticeDegree", omStrDup(latticeDegree_help));
 ...
 module_help_proc("polymake.so","latticeCodegree", omStrDup(latticeCodegree_help));
 ...
 module_help_proc("polymake.so","ehrhartPolynomialCoeff", omStrDup(ehrhartPolynomialCoeff_help));
 ...
 module_help_proc("polymake.so","isNormal", omStrDup(isNormal_help));
 ...
 module_help_proc("polymake.so","facetWidths", omStrDup(facetWidths_help));
 ...
 module_help_proc("polymake.so","facetWidth", omStrDup(facetWidth_help));
 ...
 module_help_proc("polymake.so","facetVertexLatticeDistances", omStrDup(facetVertexLatticeDistances_help));
 ...
 module_help_proc("polymake.so","isCompressed", omStrDup(isCompressed_help));
 ...
 module_help_proc("polymake.so","isSmooth", omStrDup(isSmooth_help));
 ...
 module_help_proc("polymake.so","isVeryAmple", omStrDup(isVeryAmple_help));
 ...
 module_help_proc("polymake.so","latticePoints", omStrDup(latticePoints_help));
 ...
 module_help_proc("polymake.so","nLatticePoints", omStrDup(nLatticePoints_help));
 ...
 module_help_proc("polymake.so","interiorLatticePoints", omStrDup(interiorLatticePoints_help));
 ...
 module_help_proc("polymake.so","nInteriorLatticePoints", omStrDup(nInteriorLatticePoints_help));
 ...
 module_help_proc("polymake.so","boundaryLatticePoints", omStrDup(boundaryLatticePoints_help));
 ...
 module_help_proc("polymake.so","nBoundaryLatticePoints", omStrDup(nBoundaryLatticePoints_help));
 ...
 module_help_proc("polymake.so","hilbertBasis", omStrDup(hilbertBasis_help));
 ...
 module_help_proc("polymake.so","nHilbertBasis", omStrDup(nHilbertBasis_help));
 ...
 module_help_proc("polymake.so","minkowskiSum", omStrDup(minkowskiSum_help));
 ...
 module_help_proc("polymake.so","minimalValue", omStrDup(minimalValue_help));
 ...
 module_help_proc("polymake.so","maximalValue", omStrDup(maximalValue_help));
 ...
 module_help_proc("polymake.so","minimalFace", omStrDup(minimalFace_help));
 ...
 module_help_proc("polymake.so","maximalFace", omStrDup(maximalFace_help));
 ...
 module_help_proc("polymake.so","visual", omStrDup(visual_help));

  const char* normalFan_help =
    "USAGE:    normalFan(polytope p)\nRETURN:   fan,\nKEYWORDS: polytopes; polymake; visualization;\nEXAMPLE:  example visual shows an example\n";

    module_help_proc("polymake.so","normalFan", omStrDup(normalFan_help));
